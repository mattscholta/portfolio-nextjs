...
export interface OctocatProps extends Icon {}
...
export const Octocat = (props: OctocatProps) => {
  ...
  return (
    <svg
      ...
      viewBox="0 0 250 250"
    >
      {/* <title>Project available on Github</title> */}
      {/* <desc>Github "Octocat" Icon</desc> */}
      <path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z" fill={fill} />
      <path
